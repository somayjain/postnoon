...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<p id="page-intro">Enter Balance Sheet Details</p>
	...
	<form action="BalanceSheet_insert.php" method="post">
							...
							<p>
									<label>Process Name:</label>
										<input class="text-input small-input" type="text" name="ProcessName" />
							...
							<p>
									<input type="radio" name="I_O" value="I" checked="checked" /> Input
									<input type="radio"  name="I_O" value="O" /> Output
								</p>
								
								<p>
									<label>Amount:</label>
										<input class="text-input small-input" type="text" name="Amount" />

								</p>
								
								<p>	<label>Department Name:</label>
										<input class="text-input small-input" type="text" name="DepartmentName" />
								</p>	
