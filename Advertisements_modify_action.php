...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Advertisements Form</h2>
			<p id="page-intro">Enter Advertisements Details</p>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Invoice Number :</label>
										<input class="text-input small-input" type="text" name="Invoice_No" />
								</p>
								<p>
									<label>Cost :</label>
										<input class="text-input small-input" type="text" name="Cost" />

								</p>
								
								<p>	<label>Product :</label>
										<input class="text-input small-input" type="text" name="Product" />
								</p>	
	
								<p>	<label>Printing Date :</label>
										<input type="date" name="Printing_Date">
								</p>

								<p>	<label>Number of Ads :</label>
										<input class="text-input small-input" type="text" name="Number_of_Ads" />
								</p>	

								<p>	<label>Handeled By :</label>
										<input class="text-input small-input" type="text" name="Handeled_By" />
								</p>	

								<p>	<label>Client Name :</label>
										<input class="text-input small-input" type="text" name="clientname" />
								</p>	
