...
$id = $_POST["EmployeeID"];
$query="SELECT * FROM Payroll WHERE EmployeeID='$id'";
...
<?php
	if($_SESSION['isadmin']==1)
		echo "	<li> 
					<a href='users.php' class='nav-top-item'>					Users
					</a>
					<ul>
...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Payroll Form</h2>
			<p id="page-intro">Enter Payroll Details</p>
	...
	<form action="payroll_insert_modify.php" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Employee ID:</label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="empid" value=<?php echo row['EmployeeID'];  ?> readonly="readonly" />

										<br /><small>Cannot change your unique Employee ID</small>
								</p>
								
							<p>
									<label>Salary</label>
										<input class="text-input small-input" type="text" name="salary" value = <?php echo row['Salary']; ?>/>

								</p>
								<p>
									<label>Paycut(Optional):</label>
										<input class="text-input small-input" type="text" name="paycut" value = <?php echo row['Pay_cut']; ?>/>
								...
								<p>
									<label>	Month :</label>              
									<input class="text-input small-input" type="text" name="month" value = <?php echo row['Month']; ?>/>
								</p>

								<p>	<label>PPF: </label>
										<input class="text-input small-input" type="text" name="ppf" value=<?php echo row['PPF']; ?>/>
								</p>	
