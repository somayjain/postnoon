...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
	...
	<form action="payroll_insert.php" method="post">
							...
							<p>
									<label>Salary</label>
										<input class="text-input small-input" type="text" name="salary" />

								</p>
								<p>
									<label>Paycut(Optional):</label>
										<input class="text-input small-input" type="text" name="paycut" />
								...
								<p>
									<label>	Month :</label>              
									<select name="month" class="small-input"  id="month">
									<script type="text/javascript">
										for(i=1; i<=12; i++)
								...
								<p>	<label>PPF: </label>
										<input class="text-input small-input" type="text" name="ppf" />
								</p>	
