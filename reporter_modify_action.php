...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Reporter Form</h2>
			<p id="page-intro">Enter Reporter Details</p>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Employee ID:</label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="empid" />

										<br /><small>Enter your unique Employee ID</small>
								</p>
								
							<p>
									<label>	No. of articles submitted:</label>
										<input class="text-input small-input" type="text" name="submitted" />

								</p>
								<p>
									<label>No. of articles published:</label>
										<input class="text-input small-input" type="text" name="published" />

								</p>
								
								<p>	<label>	Category:</label>
										<input class="text-input small-input" type="text" name="category" />
								</p>	
