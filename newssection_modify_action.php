...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>News Section Form</h2>
			<p id="page-intro">Enter News Section Details</p>
	...
	<form action="newssection_insert.php" method="post">
							...
							<p>
									<label>Category Name: </label>
										<input class="text-input small-input" type="text" name="categoryname" />

								</p>
								<p>
									<label>Assistant Editor ID:</label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="assistantid" />
								</p>
								<p>
									<label>Sub Editor ID: </label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="subeditorid" />
								</p>
								<p>
									<label>Handeled By Department: </label>
										<input class="text-input small-input" type="text" name="handeledbydept" />
