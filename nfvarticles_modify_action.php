...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>NFV atrivles Form</h2>
			<p id="page-intro">Enter NFV articles Details</p>
	...
	<form action="nfvarticles_insert.php" method="post">
							...
							<p>
									<label>Topic:</label>
										<input class="text-input small-input" type="text" name="topic" />

								</p>
								<p>
									<label>Page No:</label>
										<input class="text-input small-input" type="text" name="pageno" />
								...
								<p>	<label>Vendor Name:</label>
										<input class="text-input small-input" type="text" name="vendor" />
								</p>	
