...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Clicks For Form</h2>
			<p id="page-intro">Enter Clicks For Details</p>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Reporter ID:</label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="reporterid" />
								</p>
								
								<p>
									<label>Photographer ID:</label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="photographerid" />
								</p>
