...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Local Distributer Form</h2>
			<p id="page-intro">Enter Local Distributer Details</p>
	...
	<form action="localdistributer_insert.php" method="post">
							...
							<p>
									<label>Area:</label>
										<input class="text-input small-input" type="text" name="area" />
								</p>
							<p>	<label>Date:</label>
								...
								<p>
									<label>Amount Of Paper Sold:</label>
										<input class="text-input small-input" type="text" name="papersold" />
								</p>
								
								<p>
									<label>Money Collected:</label>
										<input class="text-input small-input" type="text" name="money" />
								</p>
