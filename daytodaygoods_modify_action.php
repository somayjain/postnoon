...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Day-to-Day Goods Form</h2>
			<p id="page-intro">Enter Day-to-Day Goods Details</p>
	...
	<form action="daytodaygoods_insert.php" method="post">
							...
							<p>
								...
								<p>
									<label>Bought By:</label>
										<input class="text-input small-input" type="text" name="boughtby" />
								</p>
