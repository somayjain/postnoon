...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Paper Vendor Form</h2>
			<p id="page-intro">Enter Paper Vendor Details</p>
	...
	<form action="papervendor_insert.php" method="post">
							...
							<p>
								...
								<p>	<label>Handeled By:</label>
										<input class="text-input small-input" type="text" name="handeledby" />
								</p>	
