...
$id2 = $_POST["Name"];
$id2 = "'$id2'";
$query="SELECT * FROM Dependents WHERE EmployeeID='$id' and Name = $id2";
...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Dependents Form</h2>
			<p id="page-intro">Enter Dependents Details</p>
	...
	<form action="dependents_insert_modify.php" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Name:</label>
										<input class="text-input small-input" type="text" name="name" value = <?php echo $row['Name']; ?> readonly="readonly" />
								</p>


								<p>
									<label>Age:</label>
										<input class="text-input small-input" type="text" name="age" value = <?php echo $row['Age']; ?> />
								</p>

								<p>
									<label>Sex</label>
									<input class="text-input small-input" type="text" name="sex" value = <?php echo $row['Sex']; ?> />
								</p>
