...
<li><a href=daytodaygoods_modify.php>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<p id="page-intro">Enter Department Details</p>
	...
	<form action="department_insert.php" method="post">
							...
							<p>
									<label>Department Name:</label>
										<input class="text-input small-input" type="text" name="DName" />
								</p>
								<p>
									<label>Head Of Department ID:</label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="HOD_ID" />

										<br /><small>Enter your unique HOD ID</small>
								</p>
