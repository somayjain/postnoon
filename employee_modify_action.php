...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="resources/scripts/simpla.jquery.configuration.ijs"></script>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					<a href="employee_form.php" class="nav-top-item current"> <!-- Add the class "current" to current menu item -->
					Employee
					</a>
					<ul>
						<li><a class="current" href="employee_form.php">Insert</a></li>
...
<li><a href=circulationarea_modify>Modify Entry</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Employee Form</h2>
			<p id="page-intro">Modify Employee Details</p>
	...
	<form action="employee_insert_modify.php" method="post" id ="form">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Employee ID:</label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="employeeid" value = <?php echo $row['EmployeeID']; ?> readonly="readonly">

										<br /><small>Cannot change your Employee ID</small>
								</p>
								
							<p>
									<label>Department Name:</label>
										<input class="text-input small-input" type="text" name="deptname" value = <?php echo $row['Department_Name']; ?>/>

								</p>
								<p>
									<label>First Name:</label>
										<input class="text-input small-input" type="text" name="firstname" value = <?php echo $row['FName']; ?>/>

								</p>
								
								<p>	<label>Middle Name:</label>
										<input class="text-input small-input" type="text" name="middlename" value = <?php echo $row['MName']; ?>/>
								</p>	
	
								<p>	<label>Last Name:</label>
										<input class="text-input small-input" type="text" name="lastname" value = <?php echo $row['LName']; ?>/>
								</p>	
								...
								<p>
									...
									<input name="bloodgroup" class="text-input small-input" type="text" id="bloodgroup" value= <?php echo $row['BloodGroup']; ?> />
								</p>

								<p>	<label>Email:</label>
										<input class="text-input small-input" type="text" name="email" value = <?php echo $row['Email']; ?>/>
								</p>	

								<p>	<label>Phone No:</label>
										<input class="text-input small-input" type="text" name="phoneno" size="10" maxlength="10" value = <?php echo $row['PhoneNo']; ?> />
								</p>	

								<p>	<label>Working Hours:</label>
										<input class="text-input small-input" type="text" name="workinghours" value = <?php echo $row['WorkingHours']; ?> />
								</p>	

								<p>	<label>Probation Period:</label>
										<input class="text-input small-input" type="text" name="probationperiod" value = <?php echo $row['ProbationPeriod']; ?> />
								</p>	
								...
								<p>	<label>Date Of Joining:</label>
										<input type="date" name="joiningdate" value = <?php echo $row['JoiningDate']; ?>>
								</p>
								<p>
									<label>	Level of Employment:</label>              
									<select name="level" class="small-input"  id="level">
									<?php
										if($row['LevelofEmployment']=="H")
										{
									?>
							...
							<p>	<label>Living Status</label>
										<input class="text-input small-input" type="text" name="livingstatus" value = <?php echo $row['LivingStatus']; ?>/>
								</p>	
								<p>	<label>Date Of Birth:</label>
										<input type="date" name="date" value = <?php echo $row['DOB']; ?> />
								</p>
							...
							<p>	<label>Living Status</label>
								...
								<p>
									<input class="button" value="Submit" onclick="func1()" />
								</p>
