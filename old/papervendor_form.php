...
<li>
<a href=adclients_form.php class="nav-top-item current">
adclients
</a>
<ul>
<li><a class="current" href=adclients_form.php>Insert</a></li>
...
<li><a href=localdistributer_modify>Modify Entry</a></li>
</ul>
</li>
<li>
...
<li><a href=papervendor_modify>Modify Entry</a></li>
</ul>
</li>
<li>
...
<li><a href=daytodaygoods_modify>Modify Entry</a></li>
</ul>
</li>	
			<!-- End #main-nav -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>Ad Clients Form</h2>
			<p id="page-intro">Enter Ad Clients Details</p>
	...
	<form action="adclients_insert.php" method="post">
							...
							<p>
									<label>Manager ID:</label>
										<input class="text-input small-input" type="text" size="9" maxlength="9" name="managerid" />

										<br /><small>Enter your unique Manager ID</small>
								</p>
